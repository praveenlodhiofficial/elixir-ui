...
const DEFAULT_EVENT: Required<EventCardProps> = {
  id: "1",
...
export function EventCard(props: EventCardProps) {
  ...
  return (
    <motion.div
      ...
      className="not-prose max-h-120 w-75 origin-bottom overflow-hidden rounded-xl border shadow will-change-transform md:rounded-2xl"
    >
      <Link
