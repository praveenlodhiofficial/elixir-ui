...
import { mergeRefs } from "@/web/utils/merge-refs";
import { useCopyButton } from "@/web/utils/use-copy-button";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        tabIndex={0}
        className={cn(
          "fd-scroll-container focus-visible:ring-fd-ring max-h-[600px] overflow-auto py-3.5 text-[0.8125rem] focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset",
...
export function CodeBlockTabsList(props: ComponentProps<typeof TabsList>) {
  return (
    <TabsList
      {...props}
      className={cn(
        "hide-scrollbar text-fd-muted-foreground flex flex-row overflow-x-auto px-2",
        props.className
      )}
    >
      {props.children}
