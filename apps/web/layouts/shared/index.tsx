  ...
  if (twitterUrl) {
    result.push({
      ...
      icon: (
        <svg role="img" viewBox="0 0 24 24" fill="currentColor">
          {/* X (Twitter rebrand) */}
          <path d="M18.244 2H21l-6.61 7.56L22 22h-6.828l-5.34-6.99L3.64 22H1l7.06-8.07L2 2h6.828l4.86 6.41L18.244 2Zm-2.39 18h1.89L8.27 4H6.24l9.614 16Z" />
        </svg>
      ),
    });
  }
...
export function useLinkItems({
  ...
  twitterUrl,
  links,
}: Pick<BaseLayoutProps, "links" | "githubUrl" | "twitterUrl">) {
  return useMemo(() => {
    const all = resolveLinkItems({ links, githubUrl, twitterUrl });
