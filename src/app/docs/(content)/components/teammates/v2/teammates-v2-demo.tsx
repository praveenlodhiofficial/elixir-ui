import TeamMatesv2 from '@/registry/default/teammates/components/teammates-v2'
...
export default function Teammatesv2Demo() {
     return (
          <div className="scale-75">
               <TeamMatesv2 teamMembers={teamMembers} nameSize="xl" descriptionSize="sm" />
          </div>
     )
}
