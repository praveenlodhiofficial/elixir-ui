...
export default function Team1Page() {
    const team1Count = Object.keys(team1Data).length;
            ...
            <div className="grid grid-cols-2 gap-4 group">
                ...
                <div className="flex flex-col gap-4">
                    {oddIndexCards.map((index) => (
                        <Link key={index} href={`/docs/components/team/${index + 1}`} className="flex flex-col gap-4 group/card">
                            <Image
                                src={`/components/team/team${index + 1}.png`}
                                alt={`Team ${index + 1}`}
                                width={500}
                                height={500}
