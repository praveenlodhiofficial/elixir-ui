...
import { ArrowRight, Sparkles, Zap, Palette, Code, Download, Star, Users, Github } from 'lucide-react'
...
const Home = () => {
     ...
     return (
          <>
               ...
               {/* Background Pattern */}
               <div className="fixed inset-0 z-[-1] bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-black dark:to-slate-900">
               ...
               <div className="min-h-screen">
                         ...
                         <div className="mx-auto max-w-4xl">
                              <div className="mb-8 flex items-center justify-center gap-2">
                                   <div className="flex items-center gap-2 rounded-full bg-lime-100 px-4 py-2 text-sm font-medium text-lime-800 dark:bg-lime-900/20 dark:text-lime-300">
                                        ...
                                        Now with 5+ Premium Components
                                   </div>
                              </div>
                              
                              <h1 className="mb-6 text-5xl font-bold tracking-tight text-slate-900 dark:text-slate-100 sm:text-6xl lg:text-7xl">
                                   Beautiful by Default
                                   <span className="block text-lime-600 dark:text-lime-400">Customizable by Design</span>
                              </h1>
                              
                              <p className="mb-8 text-lg text-slate-600 dark:text-slate-400">
                                   Copy-paste beautiful, responsive components without worrying about styling or animations. 
                                   br/
                                   Build faster, launch sooner with our premium component library.
                              </p>
                              
                              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                                   <Button size="lg" className="group bg-lime-600 hover:bg-lime-700 dark:bg-lime-500 dark:hover:bg-lime-600">
                                        Browse Components
                         ...
                         <div className="mx-auto max-w-6xl">
                              ...
                              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                                   ...
                                   <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-zinc-900 dark:bg-zinc-900">
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400">
                                             High-quality components that you can trust for production applications.
                                        </p>
                                   </div>
                                   ...
                                   <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-zinc-900 dark:bg-zinc-900">
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400">
                                             Built by developers, for developers. Open source and community maintained.
                                        </p>
                                   </div>
                              </div>
                         </div>
                    ...
                    <section className="px-4 py-20 bg-transparent">
                         <div className="mx-auto max-w-6xl">
                              <div className="grid gap-8 text-center md:grid-cols-3">
                                   <div>
                                        <div className="mb-2 text-4xl font-bold text-lime-600 dark:text-lime-400">5+</div>
                                        <div className="text-slate-600 dark:text-slate-400">Premium Components</div>
                                   </div>
                                   <div>
                                        <div className="mb-2 text-4xl font-bold text-lime-600 dark:text-lime-400">100%</div>
                                        <div className="text-slate-600 dark:text-slate-400">TypeScript Ready</div>
                                   </div>
                                   <div>
                                        <div className="mb-2 text-4xl font-bold text-lime-600 dark:text-lime-400">∞</div>
                                        <div className="text-slate-600 dark:text-slate-400">Customizable</div>
                                   </div>
                              </div>
                         </div>
                    </section>
                    ...
                    <section className="px-4 py-20">
                         <div className="mx-auto max-w-4xl text-center">
                              ...
                              <p className="mb-8 text-lg text-slate-600 dark:text-slate-400">
                                   Start building beautiful interfaces today with Elixir UI components.
                              </p>
                              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                                   <Button size="lg" className="group bg-lime-600 hover:bg-lime-700 dark:bg-lime-500 dark:hover:bg-lime-600">
                                        Get Started
                    ...
                    {/* Footer */}
                    <footer className="border-t border-slate-200 bg-white px-4 py-12 dark:border-slate-800 dark:bg-black rounded-tl-4xl rounded-tr-4xl">
                         <div className="mx-auto max-w-6xl">
                              <div className="grid gap-8 md:grid-cols-4">
                                   ...
                                   <div>
                                        <h4 className="mb-4 font-semibold text-slate-900 dark:text-slate-100">Components</h4>
                                        <ul className="space-y-2 text-slate-600 dark:text-slate-400">
                                             <li><Link href="/docs/components/liquid-frame" className="hover:text-lime-600">Liquid Frame</Link></li>
                                             <li><Link href="/docs/components/vanilla-tilt-card" className="hover:text-lime-600">Tilt Card</Link></li>
                                             <li><Link href="/docs/components/showcase" className="hover:text-lime-600">Showcase</Link></li>
                                             <li><Link href="/docs/components/sidemenu" className="hover:text-lime-600">Side Menu</Link></li>
                                        </ul>
                                   </div>
                                   <div>
                                        <h4 className="mb-4 font-semibold text-slate-900 dark:text-slate-100">Resources</h4>
                                        <ul className="space-y-2 text-slate-600 dark:text-slate-400">
                                             <li><Link href="/docs" className="hover:text-lime-600">Documentation</Link></li>
                                             <li><Link href="/templates" className="hover:text-lime-600">Templates</Link></li>
                                             <li><Link href="/try" className="hover:text-lime-600">Try Online</Link></li>
                                             <li><Link href="/request-component" className="hover:text-lime-600">Request Component</Link></li>
                                        </ul>
                                   </div>
                                   <div>
                                        <h4 className="mb-4 font-semibold text-slate-900 dark:text-slate-100">Community</h4>
                                        <ul className="space-y-2 text-slate-600 dark:text-slate-400">
                                             <li><Link href="https://github.com" className="hover:text-lime-600">GitHub</Link></li>
                                             <li><Link href="https://twitter.com" className="hover:text-lime-600">Twitter</Link></li>
                                             <li><Link href="/contact" className="hover:text-lime-600">Contact</Link></li>
