...
interface TeamMatesPropsv1 {
  teamMembers: TeamMember[]
}

export default function TeamMatesv1({ teamMembers }: TeamMatesPropsv1) {
    ...
    <section className="flex flex-col items-center justify-center md:min-h-[50vh] h-fit w-full text-white gap-8 p-5 md:my-10">
      ...
      <div className="relative h-[120px] md:h-[150px] w-full overflow-hidden [clip-path:inset(0_0_0_0)]">
        <div className="absolute w-full h-full flex items-center justify-center overflow-hidden" ref={(el) => void (namesRef.current[0] = el)}>
          <h1
            className="absolute w-full text-center font-barlow-condensed font-extrabold md:font-semibold text-4xl md:text-[110px] uppercase dark:text-white text-black"
        ...
        {teamMembers.map((member, index) => (
          ...
          >
            <h1
              className="absolute w-full text-center font-barlow-condensed font-extrabold md:font-semibold text-4xl md:text-[110px] uppercase text-[#ff3333] translate-y-full"
