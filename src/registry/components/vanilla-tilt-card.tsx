...
const vanillaTiltCardVariants = cva('hover:shadow-lg flex px-6 py-5 rounded-sm', {
     variants: {
          variant: {
...
interface VanillaTiltCardProps
     extends React.HTMLAttributes<HTMLDivElement>,
          VariantProps<typeof vanillaTiltCardVariants> {
     options?: {
          max?: number
          speed?: number
          glare?: boolean
...
export default function VanillaTiltCard({
     ...
     return (
          <div
               ref={tiltRef}
               className={cn(vanillaTiltCardVariants({ variant, size }), className)}
               style={{
