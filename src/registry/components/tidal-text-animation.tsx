...
interface TidalContentAnimationProps {
     teamMembers: TidalTextAnimationProps[]
     defaultText?: string
}

export default function TidalTextAnimation({ teamMembers, defaultText = 'Enter Team Name' }: TidalContentAnimationProps) {
